...
folder = 'C:/Users/Abbad/Desktop/Winter21-22/AIS/Project/FRA-UAS-Automation-LAB-main/FRA-UAS-Automation-LAB-main/data/New_json/frauas_3classes/'
for i in range(6):
    ...
    for file in f1:
        ...
        if name in f:
            ...
            print("label_file", json_dir+name+'.json')
